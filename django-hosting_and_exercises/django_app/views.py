...
#     return render(request, 'django_app/chat.html', {'messages': messages, 'room_name': room_name})
#
#
# def new_message(request, room_name):
#     user = request.user
#     message = request.POST['message']
#     message_obj = Message.objects.create(user=user, message=message, room_name=room_name)
#     return redirect('django_app:chat', room_name=room_name)
#
#
